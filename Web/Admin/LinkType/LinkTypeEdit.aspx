<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LinkTypeEdit.aspx.cs" Inherits="Maticsoft.Web.Admin.LinkType.LinkTypeEdit" %>
            ...
            <Rows>
                ...
                <f:FormRow>
                    <Items>
                        ...
                        <f:DropDownList Label="分类组" AutoPostBack="false" Required="true" ShowRedStar="true" runat="server" ID="ddlfatherId">
                        </f:DropDownList>
