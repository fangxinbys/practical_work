<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PicList.aspx.cs" Inherits="Maticsoft.Web.Admin.PicType.PicList" %>
...
<body>
    <form id="form1" runat="server">
                ...
                <f:Grid ID="GridDpt" runat="server" ShowBorder="false" ShowHeader="false" OnPageIndexChange="GridDpt_PageIndexChange"
                    ...
                    <Toolbars>
                        <f:Toolbar ID="Toolbar1" Position="Top" runat="server">
                            <Items>
                                ...
                                <f:Button ID="btnNew" runat="server" Icon="Add" Text="新增分类" OnClick="btnNew_Click">
                                </f:Button>
                            </Items>
                        </f:Toolbar>
                    </Toolbars>
                    <Columns>
                        ...
                        <f:LinkButtonField ColumnID="deleteField" TextAlign="Center" Icon="Delete" ToolTip="删除"
                            ConfirmText="确定删除该分类及图片？" ConfirmTarget="Top" CommandName="Delete" Width="50px" />
                    </Columns>
                </f:Grid>
            </Items>
        </f:Panel>
        ...
        <f:Window ID="Window1" Hidden="true" EnableIFrame="true" runat="server" OnClose="Window1_Close"
            EnableMaximize="true" EnableResize="true" Target="Top" IsModal="True" Width="600px" Title="分类编辑"
            Height="340px">
        </f:Window>
    </form>
</body>
