<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ArtTypeList.aspx.cs" Inherits="Maticsoft.Web.Admin.ArtType.ArtTypeList" %>
                ...
                <f:Grid ID="GridMenu" runat="server" ShowBorder="false" EnableMultiSelect="false" KeepCurrentSelection="true" ShowHeader="false" DataKeyNames="Id" OnRowCommand="GridMenu_RowCommand">
                    ...
                    <Columns>
                        ...
                        <f:TemplateField Width="80px" HeaderText="状态">
                            <ItemTemplate>
                                <asp:Label runat="server" ID="zt" Text='<%# GetZt(Eval("IsEnable").ToString()) %>'></asp:Label>
                            </ItemTemplate>
                        </f:TemplateField>
                        ...
                        <f:LinkButtonField ColumnID="deleteField" TextAlign="Center" Icon="Delete" ToolTip="删除"
                            ConfirmText="确定删除该分类及其文章？" ConfirmTarget="Top" CommandName="Delete" Width="100px" />
                    </Columns>
                    <Toolbars>
