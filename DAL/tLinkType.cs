...
namespace Maticsoft.DAL
{
	...
	public partial class tLinkType
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("Id", "tLinkType"); 
		}
		...
		public bool Exists(int Id)
		{
			...
			strSql.Append("select count(1) from tLinkType");
		...
		public bool Delete(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from tLinkType ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,Name,Sort,FatherID ");
			strSql.Append(" FROM tLinkType ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" Id,Name,Sort,FatherID ");
			strSql.Append(" FROM tLinkType ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from tLinkType T ");
