...
namespace Maticsoft.DAL
{
	...
	public partial class tArticleType
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("Id", "tArticleType"); 
		}
		...
		public bool Exists(int Id)
		{
			...
			strSql.Append("select count(1) from tArticleType");
		...
		public bool Delete(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from tArticleType ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,Name,Sort,FatherID,IsEnable ");
			strSql.Append(" FROM tArticleType ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" Id,Name,Sort,FatherID,IsEnable ");
			strSql.Append(" FROM tArticleType ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from tArticleType T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "tArticleType";
